...
os.system('xdg-open http://wa.me/+  https://www.facebook.com/profile.php?id=100072565929405')
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+ https://www.facebook.com/profile.php?id=100072565929405  ?text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
